...
// ---------------------------------------------------------------------------
// USB export: browse the mirror, copy onto a plugged-in drive, eject it.
...
async function refreshUsbExport() {
  ...
  document.getElementById("usb-copy").disabled = !!(job && job.running);
  document.getElementById("usb-eject").disabled = !!(job && job.running);
}
